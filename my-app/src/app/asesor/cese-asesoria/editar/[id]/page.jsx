// app/asesor/cese-asesoria/editar/[id]/page.jsx
'use client'
    ...
    setTimeout(() => {
      ...
      const solicitudEjemplo = {
        ...
        tesistas: [
          ...
          { id: "T002", nombre: "Juan Carlos Mendoza", codigo: "20170045", titulo: "Sistema de reconocimiento facial para seguridad institucional", etapa: "Investigación", avance: 20, seleccionado: false },
